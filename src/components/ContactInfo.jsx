...
export default function ContactInfo({
  ...
  return (
    <>
      <address className="text-xl md:text-2xl md:justify-between justify-center md:items-start items-center flex flex-col gap-5">
        <a
          ...
          >
            ...
            {showTooltip && (
              <div
                ref={tooltipRef}
                tabIndex={-1}
                className="z-10 absolute -top-11 bg-gray-700 rounded-xl rounded-bl-none w-52 py-2 text-center box-border opacity-90 text-gray-200 -right-52"
              >
                {t("copy")}
              </div>
            )}
